...
import labelVertex from './label-vertex.gsls';
 ...
 */
export default class XYAxesLayer extends Layer {
  initializeState() {
...
XYAxesLayer.layerName = 'XYAxesLayer';
XYAxesLayer.defaultProps = defaultProps;